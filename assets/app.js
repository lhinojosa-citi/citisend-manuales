...
const fallbackProjects = [
  ...
  },
  {
    ...
    "contactos": [
      ...
      {
        "nombre": "Diego",
        "rol": "Seguimiento de proyecto",
        "empresa": "FCC",
        "tipo": "Cliente"
      },
      {
        "nombre": "Félix",
        "rol": "Incidencias y zonas",
        "empresa": "FCC",
        "tipo": "Cliente"
      }
    ],
...
async function loadJson(path, fallback){
  try{
    const response = await fetch(`${path}?v=1.5`, {cache:'no-store'});
